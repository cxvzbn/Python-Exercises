...
# number of positions down the alphabet. For example, with a shift of 3, A
# would be replaced by D, B would become E, and so on. The method is named
# after Julius Caesar, who used it to communicate with his generals. ROT­13
# ("rotate by 13 places") is a widely used example of a Caesar cipher where
# the shift is 13. In Python, the key for ROT­13 may be represented by means
...
# Note that since English has 26 characters, your ROT­13 program will be able
# to both encode and decode texts written in English.
    ...
    for word in sentence.split():
        for letter in word:
            if 97 <= ord(letter) <= 122:
                ...
                new_sentence = new_sentence + chr(new_letter)
